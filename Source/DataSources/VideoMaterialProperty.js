...
define([
    ...
    function syncVideo(video, animationRate, result, currentTime) {
        ...
        var videoTime = JulianDate.secondsDifference(currentTime, result.startTime);
    ...
    defineProperties(VideoMaterialProperty.prototype, {
         ...
         * @type {Property}
         */
        horizontalRepeat : createPropertyDescriptor('horizontalRepeat'),
         ...
         * @type {Property}
         */
        verticalRepeat : createPropertyDescriptor('horizontalRepeat'),
    ...
    VideoMaterialProperty.prototype.getValue = function(time, result, context) {
        ...
        if(videoLoaded && previousTime !== 'undefined' && previousSystemTime !== 'undefined') {
            ...
            var deltaAnimationTime = JulianDate.secondsDifference(time, previousTime);
