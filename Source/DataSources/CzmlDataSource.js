...
define([
    ...
    function processScreenOverlay(entity, packet, entityCollection, sourceUri) {
        ...
        var screenOverlay = entity.screenOverlay;
        if (!defined(screenOverlay)) {
            entity.screenOverlay = screenOverlay = new ScreenOverlayGraphics();
        }
